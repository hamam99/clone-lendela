...
import bg from '/public/assets/images/top-wave2.svg'

const Experience = () => {
  return (
    <div
      className="flex w-full justify-center py-4 t-10 flex-col items-center bg-local bg-no-repeat bg-top"
      // style={{
      //   backgroundImage: `url(${bg.src})`
      // }}
    >
      {/* <div
        className="flex w-full bg-local bg-no-repeat bg-cover h-[200px] "
        style={{
          backgroundImage: `url(${bg.src})`
        }}
      /> */}
        ...
        <div className="max-w-[1024px] flex flex-col w-full items-center justify-center ">
          <div className="grid grid-cols-2 w-full gap-1">
            <div className="col-span-1 w-full flex flex-col mr-8">
              ...
              <div className="w-[150px] h-[2px] mt-2" />
              <p className=" mt-4">
                Through Lendela, we are bringing more than a decade worth of
                experience on how to make loan comparison easier, faster and
                more transparent for both consumers and partners.
              </p>
              <p className=" mt-4">
            ...
            <div className="col-span-1 w-full ml-8">
              ...
              <p className=" mt-4">
                It is no secret that getting a loan can be difficult - and
                knowing if you got the best deal is impossible.
                {<br />}
                ...
                <ol className="gap-4 leading-7" type="1">
                  ...
                  <li>
                    2. You do not know how to go about applying for a loan
                  </li>
                  <li>
                    3. The application process is too complicated and
                    troublesome
                  </li>
                  <li>
                  ...
                  <li>
                    5. You cannot find a party that will approve your loan
                  </li>
                  <li>
                ...
                Lendela wants to solve all of those issues for you - all with
                just one application on lendela.com.
              </p>
            </div>
          </div>
          <button className="bg-green-500 py-3 px-20 rounded-lg mt-20">
            <p className="font-bold text-white text-xl"> COMPARE NOW</p>
          </button>
        </div>
      </div>
    </div>
