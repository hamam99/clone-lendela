...
const Experience = () => {
  return (
    <div className="flex w-full justify-center py-4 bg-green-400">
      <div className="max-w-[1024px] grid grid-cols-2 w-full gap-10">
        <div className="col-span-1 w-full flex flex-col mr-8">
          ...
          <p className="text-white mt-4">
            ...
            Nordic-inspired user experience and financial technology with local
            expertise in this region. After starting in Singapore, we have also
            expanded our operations to Hong Kong.
          </p>
          <Image
        ...
        <div className="col-span-1 w-full ml-8">
          ...
          <p className="text-white mt-4">
            ...
            <ol className="gap-4 leading-7" type="1">
              ...
              <li>
                4. Banks and financial institutions are not transparent with you
                on application outcome and loan terms
              </li>
